...
/// 이번 주 소비 집계 — History 히어로(숫자 헤드라인 + 추세 화살표 + 종이 칩 일곱)가 읽는 **유일한** 규칙.
///
...
///
/// **지난 주도 같은 순회에서 센다**(추세 화살표용). 값 하나를 위해 이력을 두 번 훑으면 두 창이
...
enum ConsumptionWeek {
    ...
    struct Summary: Equatable {
        ...
        var removed: Int
        /// 지난 주(이번 주 시작 **직전** 7일) 먹은 수 — 추세 화살표 전용이라 요일 칸은 만들지 않는다.
