...
| `monoEyebrow` | Pretendard Bold 10 / 자간 1.6 / `.caption2` | 초소형 올캡 라벨 — "TABLE · REFFI KITCHEN"·"MORNING ALERTS"·"REFFI · KEEP IT FRESH"(공유 카드 푸터) |
| `sectionLabel` | Pretendard SemiBold 11 / 자간 1.4 / `.caption2` | 섹션 라벨 — "ON THE TICKET"·"RECIPE"·"INGREDIENTS"·카테고리 |
